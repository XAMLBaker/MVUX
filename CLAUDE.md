...
**MVUX.Wpf** — Uno Platform MVUX의 API 설계(인터페이스명, 메서드 시그니처, 타입 구조)를 의도적으로 모방하여 WPF에서 독립적으로 재구현한 라이브러리. 소스 복사 없이 처음부터 새로 작성.

- 플랫폼: WPF only (WinUI3, MAUI 제외)
